...
function swwitch(num){
  ...
  switch(true){
    ...
    return(
      ...
      case num == (6) : cost = 200 ;
      return([[{id: 1, number: 1, isReserved: true, tooltip: 'Reserved For TSA'}, {id: 2, number: 2,  isReserved: true, tooltip: 'Reserved For TSA'}, null, {id: 3, number: '3', isReserved: true, orientation: 'east', tooltip: 'Reserved by Donald Duck'}, {id: 4, number: '4',isReserved : true, orientation: 'west', tooltip: 'Reserved by Daisy Duck'}, null, {id: 5, number: 5,tooltip: 'Cost: 200$'}, {id: 6, number: 6,tooltip: 'Cost: 200$'}]])
      ...
      case num == 3:cost = 200;
        return([[{id: 1, number: 1, isReserved: true, tooltip: 'Reserved For TSA'},null,null, {id: 2, number: 2,  isReserved: true, tooltip: 'Cost :200$'}, null, null,null,{id: 3, number: '3', isReserved: true, orientation: 'east', tooltip: 'Reserved by Donald Duck'}]])
     
  
      case num == 2 :cost = 200;
        return([[{id: 1, number: 1, isReserved: true, tooltip: 'Reserved For TSA'}, null,null,null,null, {id: 2, number: 6,tooltip: 'Cost: 200$'}]])
     
  
     default:cost = 200;
       return([[ null,null,null,null, {id: 1, number: 1,tooltip: 'Cost: 200$'}]])
...
class Seats extends React.Component {
    ...
    return (
      <div>
        ...
        <div class="position-static" style={{float: 'right'}}>
