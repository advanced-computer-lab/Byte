...
class Seats extends React.Component {
    ...
    render() { 
        const rows = [
            [{id: 1, number: 1, isReserved: true, tooltip: 'Reserved For TSA'}, {id: 2, number: 2,  isReserved: true, tooltip: 'Reserved For TSA'}, null, {id: 3, number: '3', isReserved: true, orientation: 'east', tooltip: 'Reserved by Rogger'}, {id: 4, number: '4', orientation: 'west'}, null, {id: 5, number: 5}, {id: 6, number: 6}],
